    ...
    <body>
        ...
        <div id="formulario">
            <form action="nuevousuario.jsp"  method="post">
                ...
                <input type="text" name="NomUsu" placeholder="John" required>
                <br>
                <b>Contraseña:</b><br>
                <input type="password" name="ConUsu" placeholder="Doe" required>
                <br>
                <b>Confirmar contraseña:</b><br>
                <input type="password" name="ConUsu2" placeholder="Doe también" required>
                <br><br>
